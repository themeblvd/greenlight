 ...
 * @since 1.0.0
 *
 * @param string $to Selector to jump to.
 ...
 * @param string $to Selector to jump to.
 */
function greenlight_scroll_to( $to = array() ) {

	echo greenlight_get_scroll_to( $to ); // WPCS: XSS ok, sanitization ok.
...
function greenlight_loader() {
	...
	echo greenlight_get_loader(); // WPCS: XSS ok, sanitization ok.
