...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Greenlight_Customize_Control_Grouped extends WP_Customize_Control {
		 ...
		 * @param array                $args Arguments for control, may vary.
		 * @return void
		 */
		public function __construct( $manager, $id, $args = array() ) {
			...
			if ( 'receiver' === $this->group_role && ! empty( $args['group-trigger'] ) ) {
		...
		protected function render() {
			...
			if ( 'receiver' === $this->group_role && ! empty( $this->group_trigger ) ) {
